...
class UpdateCountryPage extends StatefulWidget {
  @override
  _UpdateCountryPageState createState() => _UpdateCountryPageState();
}

class _UpdateCountryPageState extends State<UpdateCountryPage> {
  bool _isLoading = false;
  var _currentCountrySelected = 'Select Country';
  var _currentCountryCode = '0';
  ...
  Future<void> updateCountry() async {
    ...
    var res = await CallApi().postDataWithToken(data, 'usermodule/updateCountry');
    print('res - $res');
    var body = json.decode(res.body);
    print('body - $body');
